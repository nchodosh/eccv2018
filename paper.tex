...
\pagestyle{headings}
\mainmatter
\def\ECCV18SubNumber{2656}  % Insert your submission number here
...
\input{sections/Introduction-nate.tex}
\input{sections/RelatedWork.tex}
\input{sections/Approach_chaoyang.tex}
\input{sections/Experiment.tex}
\input{sections/Conclusion.tex}
\input{sections/VisualResults.tex}
\clearpage
